      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
        ...
        >
          ...
          <p className="text-center font-questrial">
            ...
            API integrations, and full-stack problem-solving. Feel free to
            explore any project that catches your eye; each has a dedicated page
            with details about the technologies used, the challenges solved, and
